...
Se ha seleccionado el sistema operativo **Windows 11** para los equipos de la empresa debido a sus ventajas en un entorno de **diseño gráfico** y **herramientas ofimáticas**. Windows 11 es compatible con la mayoría de programas profesionales de diseño, como herramientas de **edición** de **imagen**, **ilustración** y **contenido digital**.
...
También ofrece **actualizaciones de seguridad**, un buen rendimiento en equipos modernos, lo que lo convierte en una opción adecuada para este entorno y herramientas de protección como el **firewall** y **antivirus**, lo que ayuda a mantener los sistemas seguros frente a posibles amenazas.
...
En este caso, selecciona el idioma **español**. Esta configuración es **importante** ya que determina el idioma de todo el sistema operativo.

### 2.2 Selección de opción de configuración

En esta pantalla se selecciona el **tipo** de **acción** que se quiere realizar sobre el equipo.

Elige la opción "**Instalar Windows 11**", ya que se va a realizar una instalación completa del sistema operativo desde cero.

Además, marca la **casilla** que indica que se aceptan las **condiciones** de la **instalación**, incluyendo la eliminación de todos los archivos, aplicaciones y configuraciones en el equipo.
...
En este caso, selecciona "**No tengo clave de producto**", lo que permite **continuar** con la **instalación** sin activar el sistema en ese mismo momento.
...
También preguntará si se quiere una **distribución** del **teclado**, selecciona **Omitir**.
...
En esta pantalla se selecciona que **uso** va a tener el **equipo**, ya sea **personal** o **profesional** o **educativo.**

### 3.3 Configuración de cuenta

En esta pantalla se solicita **iniciar sesión** con una cuenta de **Microsoft**.

Ya que **no** es un equipo **personal**, se debe utilizar la combinación **Shift + F10** para abrir cmd y escribir: `start ms-cxh:localonly`
...
Entonces: Configuración → Red e Internet → Configuración de red avanzada → **Ethernet**

Y en más **opciones** del **adaptador**, se selecciona **IPv4** y se asigna la siguiente dirección:
...
Y para comprobar que todo está bien establecido se abre **cmd** y se ejecuta el **comando**:
...
Se han creado **distintos usuarios** con distintas **funciones** dentro de la empresa.
...
| Nombre | Nombre completo | Tipo |
|---|---|---|
| Administración | Administración | Cuenta local |
| Administrador | — | Cuenta integrada |
| Diseño | Diseño | Cuenta local |
| Invitado | — | Cuenta integrada |
| Marketing | Marketing | Cuenta local |
| Técnico | Técnico | Administrador - Cuenta local |
...
**2. Diseño**
- Solo usa programas, no accede al sistema

**3. Marketing**
- Uso normal: navegador, redes, ofimática.

**4. Administración**
- Trabajo de oficina: documentos, facturación.
...
Para ello, cada usuario debe ir a **Configuración** → Cuentas → Opciones de inicio de sesión, y ahí establecer una contraseña para iniciar sesión.

Por último, en cuanto a los **permisos** de cada usuario, se puede ver qué tipo de cuenta es cada una yendo a Configuración → Cuentas → **Otros usuarios**.
...
- **Edición** de imágenes
- **Diseño vectorial** (logos, ilustraciones)
- **Maquetación** (revistas, carteles)
...
- Tal y como se ha mencionado, **cambiarlas periódicamente**
...
- Descargar solo de **páginas oficiales**
